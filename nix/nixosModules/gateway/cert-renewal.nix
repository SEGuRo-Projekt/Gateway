...
in
{
  options = {
    services.cert-renewal = {
      ...
      estUrl = lib.mkOption {
        type = lib.types.str;
        default = "https://iotpocenvironment.westeurope.cloudapp.azure.com:8443/pgwy/est/smartgrid_herne";
        description = "Endpoint for the EST server";
      };
      subject = lib.mkOption {
        type = lib.types.str;
        default = "/CN=${cfg.commonName}/O=Nexus/C=SE";
